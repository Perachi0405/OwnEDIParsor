...
import (
	...
	"github.com/Perachi0405/ownediparse/extensions/v21/samples"
...
var benchSchema ownediparse.Schema
var benchInput []byte
...
func init() {
	...
	benchSchema, err = ownediparse.NewSchema("bench", bytes.NewReader(schema))
	if err != nil {
		panic(err)
	}
