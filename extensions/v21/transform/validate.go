...
func ValidateTransformDeclarations(
	...
	// fmt.Println("Inside the ValidateTransformDeclarations ")
	// fmt.Println("SchemaContent validateTransform", schemaContent)
	fmt.Println("custom func", customFuncs)
	fmt.Println("customParseFuncs", customParseFuncs)
	...
	// fmt.Println("omniv21 finalOutputDecl", finalOutputDecl)
	if err != nil {
		return nil, err
	}
...
func (ctx *validateCtx) validateDecl(fqdn string, decl *Decl, templateRefStack []string) (*Decl, error) {
	...
	fmt.Println("templateRefStack", templateRefStack)
...
func (ctx *validateCtx) validateXPath(fqdn string, decl *Decl, templateRefStack []string) error {
	fmt.Println("ValidateXpath", fqdn)
...
func (ctx *validateCtx) validateObject(fqdn string, decl *Decl, templateRefStack []string) error {
	fmt.Println("validateObject", fqdn)
...
func (ctx *validateCtx) validateArray(fqdn string, decl *Decl, templateRefStack []string) error {
	fmt.Println("validateArray", fqdn)
